...
def generate_godot_match_sequence(
    ...
    # Build chronological 65-second Godot timeline keyframes
    timeline: List[Dict[str, Any]] = [
        {
            ...
            "damage_dealt": 0,
            "xp_gain": 5,
            "sound_cue": "sfx_blade_whoosh" if char_a["id"] == "char_phantom_9" else "sfx_power_charge",
            "commentary": f"[0.0s] Phase 1 - Round Start: {player_a_name} ({char_a['name']}) enters arena with tactical readiness."
        },
        {
            "step": 2,
            "timestamp_sec": 3.2,
            ...
            "commentary": f"[3.2s] Phase 1 - Stance Lock: {player_b_name} ({char_b['name']}) powers up combat chassis."
        },
        {
            "step": 3,
            "timestamp_sec": 7.5,
            "actor": "player_a",
            "defender": "player_b",
            "action_type": "attack_clash",
            "card_name": p_a_atks[0]["name"] if p_a_atks else "Quick Peek",
            "defense_card": p_b_defs[0]["name"] if p_b_defs else "Antirush Guard",
            "animation_trigger": "anim_cast_slash" if char_a["id"] == "char_phantom_9" else "anim_cast_slam",
            "defense_animation": "anim_deploy_barrier",
            "damage_dealt": 12,
            "is_blocked": True,
            "xp_gain": 12,
            "sound_cue": "sfx_gunfire_burst",
            "defense_sound_cue": "sfx_shield_block",
            "commentary": f"[7.5s] Phase 2 - Opening Poke: {player_a_name} probes angle with {p_a_atks[0]['name'] if p_a_atks else 'Quick Peek'}; {player_b_name} absorbs 12 shield DMG."
        },
        {
            "step": 4,
            "timestamp_sec": 11.8,
            ...
            "commentary": f"[11.8s] Phase 2 - Tactical Utility: {player_b_name} deploys {p_b_defs[0]['name'] if p_b_defs else 'Defensive Smoke'} to deny sightlines."
        },
        {
            "step": 5,
            "timestamp_sec": 16.0,
            ...
            "defender": "player_a",
            "action_type": "attack_clash",
            "card_name": p_b_atks[0]["name"] if p_b_atks else "Flash Entry",
            "defense_card": p_a_defs[0]["name"] if p_a_defs else "Basic Hold",
            ...
            "defense_sound_cue": "sfx_shield_block",
            "commentary": f"[16.0s] Phase 2 - Utility Push: {player_b_name} fires {p_b_atks[0]['name'] if p_b_atks else 'Flash Entry'}; {player_a_name} mitigates to 14 shield DMG."
        },
        {
            "step": 6,
            "timestamp_sec": 20.5,
            ...
            "defender": "player_b",
            "action_type": "deploy_defence",
            "card_name": p_a_defs[1]["name"] if len(p_a_defs) > 1 else "Evasive Roll",
            "animation_trigger": "anim_dodge_roll",
            "damage_dealt": 0,
            "xp_gain": 10,
            "sound_cue": "sfx_dodge_woosh",
            "commentary": f"[20.5s] Phase 3 - Reposition: {player_a_name} executes an evasion roll across the arena line."
        },
        {
            "step": 7,
            "timestamp_sec": 24.8,
            ...
            "defender": "player_b",
            "action_type": "attack_clash",
            "card_name": p_a_atks[1]["name"] if len(p_a_atks) > 1 else "Double Peek",
            "defense_card": p_b_defs[0]["name"] if p_b_defs else "Layered Defense",
            "animation_trigger": "anim_cast_slash",
            "defense_animation": "anim_deploy_barrier",
            "damage_dealt": 16,
            "is_blocked": True,
            "xp_gain": 15,
            ...
            "defense_sound_cue": "sfx_shield_block",
            "commentary": f"[24.8s] Phase 3 - Skirmish Clash: {player_a_name} uses {p_a_atks[1]['name'] if len(p_a_atks) > 1 else 'Double Peek'}; {player_b_name} deflects for 16 DMG."
        },
        {
            "step": 8,
            "timestamp_sec": 29.2,
            ...
            "defender": "player_a",
            "action_type": "deploy_defence",
            "card_name": p_b_defs[1]["name"] if len(p_b_defs) > 1 else "Antirush Setup",
            "animation_trigger": "anim_deploy_barrier",
            "damage_dealt": 0,
            "xp_gain": 10,
            "sound_cue": "sfx_shield_thump",
            "commentary": f"[29.2s] Phase 3 - Fortify: {player_b_name} anchors defensive position."
        },
        {
            "step": 9,
            "timestamp_sec": 33.5,
            ...
            "defender": "player_a",
            "action_type": "attack_clash",
            "card_name": p_b_atks[1]["name"] if len(p_b_atks) > 1 else "Split Pressure",
            "defense_card": "Evasion Stance",
            "animation_trigger": "anim_cast_cannon",
            "defense_animation": "anim_dodge_roll",
            "damage_dealt": 16,
            "is_blocked": True,
            "xp_gain": 16,
            "sound_cue": "sfx_energy_blast",
            "defense_sound_cue": "sfx_dodge_woosh",
            "commentary": f"[33.5s] Phase 3 - Suppressive Fire: {player_b_name} unleashes {p_b_atks[1]['name'] if len(p_b_atks) > 1 else 'Split Pressure'}; {player_a_name} evades for 16 chip DMG."
        },
        {
            "step": 10,
            "timestamp_sec": 38.0,
            "actor": winner_actor,
            "defender": loser_actor,
            "action_type": "attack_clash",
            "card_name": "Flank Infiltration",
            "defense_card": "Shield Overload",
            "animation_trigger": "anim_cast_slash",
            "defense_animation": "anim_deploy_barrier",
            "damage_dealt": 22,
            "is_blocked": False,
            ...
            "sound_cue": "sfx_gunfire_burst",
            "defense_sound_cue": "sfx_shield_block",
            "commentary": f"[38.0s] Phase 4 - Shield Shatter: {winner_name} shatters shields with Flank Infiltration (22 DMG)!"
        },
        {
            "step": 11,
            "timestamp_sec": 42.4,
            "actor": loser_actor,
            "defender": winner_actor,
            "action_type": "emote",
            "card_name": "Energy Surge",
            "emote_trigger": "emote_taunt",
            "damage_dealt": 0,
            "xp_gain": 15,
            "sound_cue": "sfx_power_charge",
            "commentary": f"[42.4s] Phase 4 - Energy Surge: Combatants surge core power to maximum capacity!"
        },
        {
            "step": 12,
            "timestamp_sec": 46.5,
            ...
            "defender": winner_actor,
            "action_type": "attack_clash",
            "card_name": "Crossfire Blast",
            "defense_card": "Parry Stance",
            "animation_trigger": "anim_cast_cannon",
            "defense_animation": "anim_deploy_barrier",
            "damage_dealt": 24,
            "is_blocked": True,
            "xp_gain": 18,
            "sound_cue": "sfx_energy_blast",
            "defense_sound_cue": "sfx_parry_clash",
            "commentary": f"[46.5s] Phase 4 - Counter Strike: Heavy crossfire exchange hits for 24 DMG."
        },
        {
            "step": 13,
            "timestamp_sec": 50.8,
            ...
            "defender": loser_actor,
            "action_type": "attack_clash",
            "card_name": "High Velocity Breach",
            "defense_card": "Braced Stance",
            "animation_trigger": "anim_cast_slash",
            "defense_animation": "anim_hit_react",
            "damage_dealt": 28,
            "is_blocked": False,
            "xp_gain": 20,
            "sound_cue": "sfx_blade_whoosh",
            "defense_sound_cue": "sfx_gunfire_burst",
            "commentary": f"[50.8s] Phase 4 - Direct Breach: {winner_name} lands 28 HP direct damage!"
        },
        {
            "step": 14,
            "timestamp_sec": 54.0,
            "actor": winner_actor,
            "defender": loser_actor,
            "action_type": "ultimate_charge",
            "card_name": "100% ULTIMATE READY",
            "animation_trigger": "anim_idle",
            "damage_dealt": 0,
            "xp_gain": 25,
            "sound_cue": "sfx_ultimate_charge",
            "commentary": f"[54.0s] Phase 5 - TENSION PEAK: {winner_name} reaches 100% ULTIMATE ENERGY!"
        },
        {
            "step": 15,
            "timestamp_sec": 57.0,
            ...
            "card_name": "Shadow Void Finisher",
            "defense_card": "Emergency Barrier",
            ...
            "defense_sound_cue": "sfx_critical_hit",
            "commentary": f"[57.0s] Phase 5 - DECISIVE FINISHER: {winner_name} executes {auto_mvp}! Precision strike lands for 75 LETHAL CRITICAL DAMAGE!"
        },
        {
            "step": 16,
            "timestamp_sec": 60.5,
            ...
            "damage_dealt": 0,
            "xp_gain": 0,
            "sound_cue": "sfx_defeat",
            "commentary": f"[60.5s] Phase 6 - {loser_name} collapses to one knee as core shields break."
        },
        {
            "step": 17,
            "timestamp_sec": 62.5,
            ...
            "animation_trigger": "anim_victory",
            "emote_trigger": "emote_celebrate",
            "damage_dealt": 0,
            "xp_gain": 0,
            "sound_cue": "sfx_victory_fanfare",
            "commentary": f"[62.5s] Phase 6 - 🏆 MATCH VICTORY! {winner_name} dominates the arena! {win_reason}"
        },
        {
            "step": 18,
            "timestamp_sec": 65.0,
            "actor": winner_actor,
            "defender": loser_actor,
            "action_type": "match_complete",
            "damage_dealt": 0,
            "xp_gain": 0,
            "sound_cue": "sfx_victory_fanfare",
            "commentary": f"[65.0s] 🏆 Match Completed (65.0s): {winner_name} takes the championship round!"
        }
    ]
